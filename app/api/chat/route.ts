...
**يجب البدء بعرض اسم السيارة باللون الأزرق:**
<span style="color: blue; font-weight: bold;">[اسم السيارة الكامل]</span>

**ثم استخدام هذا التنسيق بالضبط:**
سعة الزيت: [X.X لتر]
اللزوجة: [XW-XX]
...
<span style="color: blue; font-weight: bold;">تويوتا كامري 2020</span>
