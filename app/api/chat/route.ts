...
**يجب استخدام هذا التنسيق المبسط بالضبط:**
سعة الزيت: [X.X لتر]
اللزوجة: [XW-XX]
...
• **استخدم أسطر منفصلة:** كل عنصر في سطر منفصل
• **أضف مسافات فارغة:** بين كل قسم ومحرك
• **عنوان المحرك:** يجب أن يكون في سطر منفصل مع مسافة قبله وبعده
• **مثال للتنسيق الصحيح:**
